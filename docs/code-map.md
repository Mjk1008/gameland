...
| Promoter / affiliate | `web/lib/promoter.ts` · PRD: [`docs/31-promoter-platform-prd.md`](31-promoter-platform-prd.md) · admin: `/admin/promoters` · dashboard: `/me/promoter` · code requests: `app_promoter_code_requests` |
