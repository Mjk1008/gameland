...
قرعه شهری بعد بستن ثبت‌نام. هر سهم یک شانس. حداکثر ۲ سید به فینال.
دعوت: کمپین بسته شده — دعوت یا سهمِ رایگانِ جدید دیگه امکان‌پذیر نیست. سهمِ رایگانِ قبلاً گرفته‌شده هنوز قابل‌استفاده‌ست.
نشانه‌ها (حداکثر ۲): [[event:ID]] [[news]] [[status]] [[go:/path|متن]]
مسیرها: /competitions /leaderboard /me /me/competitions /rules /support
