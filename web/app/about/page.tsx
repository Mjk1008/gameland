  ...
  return (
    <div className="animate-fade-up" style={{ padding: '14px 16px 28px' }}>
      ...
      <section style={section}>
        ...
        <p style={p}>جایزه‌ها رو <Link href="/sponsors" style={{ color: '#F5A623' }}>حامیان مالی</Link> تأمین می‌کنن، نه ورودی بازیکن‌ها. ورودی هر مسابقه هزینهٔ سرویس مهارتیه، نه شرط‌بندی. کیف پول سکه‌ای هم قابل تبدیل به پول نیست. این مدل با چارچوبی که سازمان نظام صنفی رایانه‌ای (IRCG) برای جام‌های قهرمانی به کار می‌بره هماهنگه.</p>
      </section>
