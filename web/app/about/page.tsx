  ...
  return (
    <div className="animate-fade-up" style={{ padding: '14px 16px 28px' }}>
      ...
      <section style={section}>
        ...
        <ul style={ul}>
          <li><b style={{color:'#22d3ee'}}>Gamer Bank</b> — پروفایل حرفه‌ای هر بازیکن، همراه با صفحهٔ افتخارات</li>
          <li><b style={{color:'#22d3ee'}}>رنکینگ ملی</b> — امتیازدهی پایدار و آفلاین‌محور</li>
          <li><b style={{color:'#22d3ee'}}>مسابقات</b> — با ۱ تا ۶ بلیط، ۶ براکت مقدماتی و فینال ۱۲۸ نفره</li>
          <li><b style={{color:'#22d3ee'}}>گیم‌نت‌ها</b> — دایرکتوری گیم‌نت‌ها و سرویس‌های مرتبط</li>
        </ul>
      </section>

      <section style={section}>
        <h2 style={h2}>چارچوب قانونی</h2>
        <p style={p}>جایزه‌ها رو <Link href="/sponsors" style={{ color: '#f5c84b' }}>حامیان مالی</Link> تأمین می‌کنن، نه ورودی بازیکن‌ها. ورودی هر مسابقه هزینهٔ سرویس مهارتیه، نه شرط‌بندی. کیف پول سکه‌ای هم قابل تبدیل به پول نیست. این مدل با چارچوبی که سازمان نظام صنفی رایانه‌ای (IRCG) برای جام‌های قهرمانی به کار می‌بره هماهنگه.</p>
      </section>
