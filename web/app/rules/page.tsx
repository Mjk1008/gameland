    ...
    <div className="animate-fade-up" style={{ padding: '14px 16px 28px' }}>
      ...
      <Section title="بلیط (۱ تا ۶)">
        <ul style={ul}>
          ...
          <li>بلیط یعنی شانس دوباره؛ بلیط بیشتر یعنی شانس بیشتر برای رسوندن <b>۲ seed</b> به فینال</li>
        </ul>
      </Section>
      ...
      <Section title="صعود و قرعه‌کشی">
        <ul style={ul}>
          ...
          <li>از هر بازیکن حداکثر <b>۲ seed</b> به فینال ۱۲۸ نفره می‌ره (حتی با ۶ بلیط)</li>
      ...
      <Section title="چارچوب مالی">
        <p style={p}>جایزه‌ها صرفاً از طرف برگزارکننده تأمین می‌شه. هیچ بخشی از ورودی بازیکنان به جایزه نمی‌ره. ورودی = هزینهٔ سرویس مهارتی (organizing fee). این چارچوب با ماده ۷۰۵ قانون مجازات اسلامی منافات نداره، چون عناصر تعریف قمار (شرط‌بندی مالی + شانس) برقرار نیستن.</p>
      </Section>
