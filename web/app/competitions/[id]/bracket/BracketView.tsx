...
type Props = { matches: MatchDTO[]; meUid?: string; isAdmin?: boolean; compId: string; venueLabels?: Record<string, string>; schedules?: Record<string, { date?: string; time?: string; note?: string }>; leftovers?: Leftover[]; todayHubEnabled?: boolean }
...
export default function BracketView({ matches, meUid, isAdmin, compId, venueLabels, schedules, leftovers, todayHubEnabled }: Props) {
