...
import { getUserById, getRegistration, getEvent, getEventConfig, profileCompletion, remainingTickets, teamForUser, captainTeamFor, currentTeamMembers, getTeam, leftoverPoolEvent } from '@/lib/store'
...
export default async function RegisterPage({ params }: { params: { id: string } }) {
  ...
  const leftoverPoolEventId = pool && pool.id !== c.id ? pool.id : undefined
