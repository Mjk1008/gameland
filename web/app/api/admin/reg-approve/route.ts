...
import { getUserById, getRegistrationById, setRegistrationStatus, getEvent, pushNotif, matchesForComp, grantReferralRewards, unpaidAttempts, hasReceipt } from '@/lib/store'
...
export async function POST(req: Request) {
  ...
  if (action === 'approve' && unpaidAttempts(r) > 0 && !hasReceipt(r.id)) {
